...
function deleteMessage(payload){
  ...
  document.getElementById("welcome").innerHTML = `<h3>Deleted ${location} from your favorites</h3>`;
}
...
function showWeather(response){
  ...
  location = location.toUpperCase();
  document.getElementById("welcome").innerHTML = `<h3>Showing weather for ${location}</h3>`;
  setCurrent(response);
  setHourly(response);
  setFiveDay(response);
